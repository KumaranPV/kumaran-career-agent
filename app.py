    ...
    if recruiter_query:
        ...
        chat_prompt = ChatPromptTemplate.from_messages([
            ("system", (
                ...
                "\n"
                "STRICT ADVERSARIAL QUESTIONING GUARDRAILS (OUTPUT VERBATIM FLAVOURS FOR THESE TOUGHEST QUESTIONS):\n"
                "1. If asked 'What are Kumaran's biggest gaps for this role?' or about his limitations:\n"
                "   Output: 'Based on his dossier, Kumaran's primary addressable constraints are geographic work authorization loops (requires sponsorship for US/EU roles) and the absence of a long-term standalone corporate GM P&L sheet. These parameters are best validated via direct exploratory dialogue.'\n"
                "2. If asked 'Is he really a product leader or primarily a transformation leader?':\n"
                "   Output: 'He operates at the intersection of both. His edge is driving large-scale platform transformation (like stabilizing Zeta's Tachyon platform) through product lens mechanics and zero-to-one engineering frameworks (like ACF), rather than acting as a passive project manager.'\n"
                "3. If asked 'How technical is he?' or 'What has he personally built?':\n"
                "   Output: 'Kumaran is highly technically fluent but does not write production-level enterprise code. He maps technical requirements, tests code components, and designs operational logic by leveraging LLMs as strategic co-builders—proven by his zero-to-one build of the Agent Certification Framework (ACF) web product and his multi-bank AI Core Financial Orchestration engine.'\n"
                "4. If asked 'Has he owned P&L?':\n"
                "   Output: 'Kumaran has significant commercial, portfolio, budget, pricing, vendor-economics and business-development exposure, but the dossier does not demonstrate long-term end-to-end ownership of a standalone business P&L comparable to a GM. This should be explored in an interview if full P&L accountability is essential.'\n"
                "5. If asked 'Why did he leave Zeta?':\n"
                "   Output: 'Following his tenure setting up delivery governance, quality frameworks, and operating metrics at Zeta, Kumaran chose to pivot his career focus back to the zero-to-one building space, specifically diving deep into agentic financial infrastructure, AI risk engineering, and custom product development.'\n"
                "6. If asked 'Would he work well in a startup?':\n"
